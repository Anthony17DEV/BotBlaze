...
def enviar_mensagem(mensagem):
    bot_token = '6154063307:AAHp_1V0rr6VMuR_lErciT462lXGCJGYNGo' #Token do bot no grupo gratuito
    chat_id = '-1001962703055' #Id grupo gratuito
...
enviar_mensagem('🎰 Bot gratuito iniciado 🎰')
while True:
    try:
        print('OK')
        esperar()
